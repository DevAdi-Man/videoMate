...
const Button = ({
  ...
  const variants = {
    primary: "bg-gradient-to-r from-primary to-accent text-white hover:shadow-lg hover:scale-105 focus:ring-primary/50",
    secondary: "bg-gray-800 text-text hover:bg-gray-700 focus:ring-gray-600",
    outline: "border-2 border-primary text-primary hover:bg-primary hover:text-white focus:ring-primary/50",
    ghost: "text-text hover:bg-gray-800/50 focus:ring-gray-600",
