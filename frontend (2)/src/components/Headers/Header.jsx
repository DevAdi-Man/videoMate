...
const Header = ({ setSlide, slide }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-gray-800/50 shadow-lg transition-transform duration-300 ${
